  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", UIManager = class UIManager {
        ...
        loadScene(sceneType, data, onProgress, onComplete, enableCircle) {
          if (enableCircle === void 0) {
            enableCircle = true;
          }

          var cfgScene = (_crd && cfg_scene === void 0 ? (_reportPossibleCrUseOfcfg_scene({
            error: Error()
          ...
          if ((_crd && AppHub === void 0 ? (_reportPossibleCrUseOfAppHub({
            error: Error()
          }), AppHub) : AppHub).ins.runningBundleName && (_crd && AppHub === void 0 ? (_reportPossibleCrUseOfAppHub({
            error: Error()
          ...
          (_crd && UBundle === void 0 ? (_reportPossibleCrUseOfUBundle({
            ...
            if (error) {
              ...
              var bundleScene = instantiate(asset);
              var baseScene = bundleScene.getComponent(_crd && SceneBase === void 0 ? (_reportPossibleCrUseOfSceneBase({
                error: Error()
              }), SceneBase) : SceneBase);
        ...
        openUI(uiId, data, enableCircle, onProgress, onComplete) {
          if (enableCircle === void 0) {
            enableCircle = true;
          }

          var cfgUi = (_crd && cfg_ui === void 0 ? (_reportPossibleCrUseOfcfg_ui({
            error: Error()
          }), cfg_ui) : cfg_ui)[uiId];
          ...
          var uiRunning = this._uiRunningPool[uiId];
          ...
          if (uiRunning) {
            ...
            var uiCache = this._uiCachePool[uiId];
            ...
            if (uiCache) {
              ...
              var loadSuccess = asset => {
                var node = instantiate(asset);
                var uiClass = node.getComponent(_crd && UIBase === void 0 ? (_reportPossibleCrUseOfUIBase({
                  error: Error()
                }), UIBase) : UIBase);
                asset.addRef();
          ...
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('111 openUI _uiRunningPool ', this._uiRunningPool);
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('111 openUI _uiCachePool ', this._uiCachePool);
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('111 openUI _prefabCachePool ', this._prefabCachePool);
        }
        /**
         * 关闭UI
         * @param uiId ui id
        ...
        closeUI(uiId, cacheMode) {
          if (cacheMode === void 0) {
            cacheMode = (_crd && EUICacheMode === void 0 ? (_reportPossibleCrUseOfEUICacheMode({
              error: Error()
          ...
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('222 openUI _uiRunningPool ', this._uiRunningPool);
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('222 openUI _uiCachePool ', this._uiCachePool);
          (_crd && ULog === void 0 ? (_reportPossibleCrUseOfULog({
            error: Error()
          }), ULog) : ULog).log('222 openUI _prefabCachePool ', this._prefabCachePool);
        }
        /**
         * 展示提示文本
         * @param text 文本内容
        ...
        showDialogMsg(msg, dialogType, okCallback, cancelCallback, closeCallback) {
          if (dialogType === void 0) {
            dialogType = (_crd && EDialogMsgType === void 0 ? (_reportPossibleCrUseOfEDialogMsgType({
              error: Error()
...
//# sourceMappingURL=4c8ce1a980d687ebc2393ab392929eecbc43b24e.js.map