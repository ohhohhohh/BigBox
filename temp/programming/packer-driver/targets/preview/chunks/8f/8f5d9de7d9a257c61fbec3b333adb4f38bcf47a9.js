  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", UTime = class UTime {
         ...
         * @returns 返回格式化后的日期
         */
        static dateFormat(date, fmt, isToBeijingDate) {
          if (isToBeijingDate === void 0) {
            isToBeijingDate = false;
          }
...
//# sourceMappingURL=8f5d9de7d9a257c61fbec3b333adb4f38bcf47a9.js.map