  ...
  return {
    ...
    execute: function () {
      ...
      _export("VLaunch", VLaunch = (_dec = ccclass('VLaunch'), _dec2 = property({
        ...
        start() {// UIManager.ins.loadScene(ESceneType.HALL, null, (finish: number, total: number, item: AssetManager.RequestItem) => {
...
//# sourceMappingURL=e200b23e33e0eb5e6986f6d67a4cdf6c32ae09f3.js.map